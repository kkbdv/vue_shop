    ...
    <el-card>
      ...
      <el-row>
        <el-table :data="orderList" border stripe>
          ...
          <el-table-column label="操作" prop="order_number" width="140px">
            <template slot-scope="scope">
              <el-button type="primary" icon="el-icon-edit" size="mini" @click="showAddressDialog"></el-button>
              <el-button type="success" icon="el-icon-location" @click="showProgeressBox(scope.row.order_number)" size="mini"></el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
